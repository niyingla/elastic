...
import com.pikaqiu.elastic.repository.SubwayRepository;
import com.pikaqiu.elastic.repository.SubwayStationRepository;
...
import com.pikaqiu.elastic.service.search.BaiduMapLocation;
...
public class AddressServiceImpl implements IAddressService {
    ...
    public ServiceMultiResult<SupportAddressDTO> findAllCities() {
        List<SupportAddress> allByLevel = supportAddressRepository.findAllByLevel(SupportAddress.Level.CITY.getValue());
        List<SupportAddressDTO> list = new ArrayList<>();
        for (SupportAddress supportAddress : allByLevel) {
            //类似于属性复制
            SupportAddressDTO supportAddressDTO = modelMapper.map(supportAddress, SupportAddressDTO.class); modelMapper.map(supportAddress, SupportAddressDTO.class);
            list.add(supportAddressDTO);
        }
